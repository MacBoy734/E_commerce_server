...
const { loginPost, registerPost, logoutGet, usersGet, changeRoleGet, forgotPasswordPost, resetPasswordPost, userOrdersGet, newsletterPost } = require('../controllers/usersController')
